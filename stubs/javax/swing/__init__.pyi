...
class JOptionPane(JComponent):
    ...
    @staticmethod
    def showOptionDialog(parentComponent: Optional[Any], message: String, title: Optional[String] = ..., optionType: Optional[int] = ..., messageType: Optional[int] = ..., icon: Optional[Icon] = ..., options: Optional[List[Any]] = ..., initialValue: Optional[Any] = ...) -> int: ...
