...
def exportExcel(
    filename: AnyStr, showHeaders: bool, dataset: List[Dataset], nullsEmpty: bool = ...
) -> AnyStr: ...
def exportHTML(
...
def setValue(
    dataset: Dataset, rowIndex: int, columnName: AnyStr, value: Any
) -> Dataset: ...
def sort(
    dataset: Dataset, keyColumn: Union[AnyStr, int], ascending: bool = ...
) -> Dataset: ...
def toCSV(
    dataset: Dataset,
    showHeaders: bool = ...,
