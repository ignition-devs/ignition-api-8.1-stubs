...
class TemporalAccessor:
    ...
    def query(self, query: TemporalQuery) -> R: ...
...
class TemporalField:
    def adjustInto(self, temporal: R, newValue: long) -> Temporal: ...
    def getBaseUnit(self) -> TemporalUnit: ...
    def getDisplayName(self, locale: Locale) -> String: ...
...
class TemporalQuery:
    def queryFrom(self, temporal: TemporalAccessor) -> R: ...
