...
class JythonMap:
    ...
    def __finditem__(self, key: Union[int, PyObject, String]) -> PyObject: ...
...
class MutableJythonMap:
    ...
    def update(self, *args: PyObject, **kwargs: String) -> None: ...
...
class MutableJythonSequence(JythonSequence):
    ...
    def sort(self, *args: PyObject, **kwargs: String) -> None: ...
